...
nonisolated enum MusicCatalog {
    ...
    private static let seeds: [Seed] = [
        ...
        Seed(artist: "Lil Peep", initials: "LP", genre: .indie, color: 0x0A84FF,
        ...
        Seed(artist: "Markul", initials: "MK", genre: .hipHop, color: 0x0A84FF,
        ...
        Seed(artist: "OG Buda", initials: "OB", genre: .hipHop, color: 0x0A84FF,
             titles: ["Молодой адвокат", "Феррари мечты"]),
        Seed(artist: "Three Days Grace", initials: "TG", genre: .rock, color: 0x0A84FF,
